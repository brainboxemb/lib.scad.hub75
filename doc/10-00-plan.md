...
Migration 011 issue #45 is complete and qualified on exact main. The current owner step is the `v0.1.8` patch release candidate for that tooling/documentation baseline. The release changes no HUB75 geometry, public API or physical-verification semantics.
