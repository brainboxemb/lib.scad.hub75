...
Can **SQ1 v0.2** hold **TL1 v0.2** square and in a repeatable position at the upper-left panel corner without forcing or twisting either part?

This test checks placement only. It does **not** judge whether the TL1 profile matches the panel. That belongs in a separate test case.
...
Place the panel with the rear/electronics side facing you and the 320 mm direction vertical. Use the physical upper-left corner shown below.

<img src="../plan/top-left-location.png" alt="Upper-left verification area on the rear of the panel" width="52%">
...
<img src="../plan/top-left-comb-square-use.png" alt="TL1 held square by SQ1 at the upper-left panel edge" width="78%">
