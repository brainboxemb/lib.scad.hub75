...
<img src="plan/top-left-location.png" alt="Rear view with upper-left verification area marked" width="55%">
...
<img src="plan/top-left-feature-map.png" alt="Upper-left rear feature map" width="72%">
...
<img src="fixtures/hub75-p5-64x32-top-left-profile-comb.png" alt="TL1 v0.1 top-left profile comb" width="72%">
...
<img src="plan/top-left-comb-use.png" alt="TL1 comb positioned on upper-left model corner" width="82%">
...
<img src="plan/top-left-comb-side.png" alt="Side view of TL1 comb on panel" width="82%">
...
| Phase | Duration |
| --- | ---: |
| Preflight + execution plan | 14.382 s |
| Cache restore | 552 ms |
| Runtime pull | 12.555 s |
| Capability materialization | 19.797 s |
| Cache save | 1.688 s |
| Validation + finishing | 756 ms |
| Snapshot preparation | 5 ms |
| **Total to prepared snapshot** | **49.909 s** |
