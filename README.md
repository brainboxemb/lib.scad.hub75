...
| Phase | Duration |
| --- | ---: |
| Preflight + execution plan | 8.213 s |
| Cache restore | 594 ms |
| Runtime pull | 11.987 s |
| Capability materialization | 15.351 s |
| Cache save | 499 ms |
| Validation + finishing | 663 ms |
| Snapshot preparation | 5 ms |
| **Total to prepared snapshot** | **37.474 s** |
