...
![Front Mask](img/03-front-mask.png)
...
![Front Stack](img/04-front-stack.png)
...
![Taper Body](img/05-taper-body.png)
...
![Bay Rounded Corner](img/06-bay-rounded-corner.png)
...
![Narrow End Width](img/07-narrow-end-width.png)
...
![Narrow Transition Left](img/08-narrow-transition-left.png)
...
![Narrow Transition Right](img/09-narrow-transition-right.png)
...
![Bay Bottom Relief](img/10-bay-bottom-relief.png)
...
![Rear Openings](img/12-rear-openings.png)
...
![Rear Frame Core](img/13-rear-frame-core.png)
...
![Reinforcement Solids](img/14-reinforcement-solids.png)
...
![Recess Bottom](img/15-recess-bottom.png)
...
![Rear Recess 3D](img/16-rear-recess-3d.png)
...
![Rear After Recess](img/17-rear-after-recess.png)
...
![Mounting Relief Single](img/18-mounting-relief-single.png)
...
![Mounting Tube Single](img/19-mounting-tube-single.png)
...
![Mounting Tubes](img/20-mounting-tubes.png)
...
![Reinforcement Inner Recess](img/21-reinforcement-inner-recess.png)
...
![Reinforcement Blind Hole](img/22-reinforcement-blind-hole.png)
...
![Locator Upper Left](img/23-locator-upper-left.png)
...
![Data Connector Bottom](img/24-data-connector-bottom.png)

Both positions use the same helper.

**View:** `data-connectors`

![Data Connectors](img/25-data-connectors.png)
...
![Power Connector](img/26-power-connector.png)
