...
# Secondary helpers retained for later stages of the physical verification plan.
render_stl \
...
echo "HUB75 functional verification output written to vrf/out"
